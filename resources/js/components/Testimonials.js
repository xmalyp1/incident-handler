...
import {Card, CardActions, Zoom} from "@material-ui/core";
...
export default function Testimonials(){
    ...
    useEffect(function (){
        ...
        return(
            <React.Fragment>
                <CssBaseline/>
                <div id="carouselExampleIndicators" className={"carousel slide " + classes.testimonialsContainer} data-ride="carousel">
                    ...
                    <div className="carousel-inner">
                        {testimonials.map((item,index) => {
                            ...
                            console.log(style)
                            return <div key={index} className={style}><TestimonialPage styleClasses={classes} testimonial={item}/></div>
                        })}
                    </div>
